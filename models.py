...
class FinancialAnalysisResult(models.Model):
    total_revenue_5cr_flag = models.IntegerField()
    borrowing_to_revenue_flag = models.IntegerField()
    iscr_flag = models.IntegerField()

    def __str__(self):
        return f"Result {self.pk} - Total Revenue 5CR Flag: {self.total_revenue_5cr_flag}, Borrowing to Revenue Flag: {self.borrowing_to_revenue_flag}, ISCR Flag: {self.iscr_flag}"
